        ...
        <div className="portfolio" ref={portfolioRef}>
             <h2>Halloween</h2>
                    <div className="panel" ref={addPanels}>
                        ...
                        <WebpG
                            src={require('../../assets/images/halloween/halloween1.webp')}
                            fallback={require('../../assets/images/halloween/halloween1.png')}
                            alt="The Halloween editorial shoots"
                            className="panel_img"
                            style={{width: '100%'}}
                        />
                        </div>
                    ...
                    <div className="panel_item">
                    <WebpG
                             src={require('../../assets/images/halloween/halloween3.webp')}
                             fallback={require('../../assets/images/halloween/halloween3.png')}
                             alt="The Halloween editorial shoots"
                             className="panel_img"
                             style={{width: '100%'}}
                        />
                ...
                <div className="panel" ref={addPanels}>
                    <div className="panel_item">
                    <WebpG
                            src={require('../../assets/images/halloween/halloween2.webp')}
                            fallback={require('../../assets/images/halloween/halloween2.png')}
                            alt="The Halloween editorial shoots"
                            className="panel_img"
                            style={{width: '100%'}}
                        />
                ...
                <div className="panel" id="landscape" ref={addPanels}>
                    <div className="panel_item">
                    <WebpG
                         src={require('../../assets/images/halloween/halloween4.jpg')}
                         fallback={require('../../assets/images/halloween/halloween4.jpg')}
                         alt="The Halloween editorial shoots"
                         className="panel_img"
                         style={{width: '100%'}}
                        />
                ...
                <div className="panel" id="landscape" ref={addPanels}>
                    <div className="panel_item">
                    <WebpG
                      src={require('../../assets/images/halloween/halloween5.webp')}
                      fallback={require('../../assets/images/halloween/halloween5.png')}
                      alt="The Halloween editorial shoots"
                      className="panel_img"
                      style={{width: '100%'}}
                        />
